...
int CompressFile_lzss_encoding(FILE *input,BIT_FILE *output,int argc,char *argv[])
{
    int i;
    int c;
...
int ExpandFile_lzss_encoding(BIT_FILE *input, FILE *output,int argc,char *argv[])
{
    int i;
    int current_position;
    int c;
