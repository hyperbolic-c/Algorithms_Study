 ...
 * It uses a fixed size code, and does not attempt
...
int CompressFile_lzw_12_bit_encoder(FILE *input, BIT_FILE *output, int argc, char *argv[])
{
    int next_code;
    int character;
    int string_code;
 ...
 */
int ExpandFile_lzw_12_bit_encoder(BIT_FILE *input, FILE *output, int argc, char *argv[])
{
